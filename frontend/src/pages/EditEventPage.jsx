    ...
    <VStack spacing={8}>
      ...
      <Box w="full" p={6} rounded="lg" shadow="md">
        <VStack spacing={4}>
          ...
          <Input type="time" value={eventData.time || ""} onChange={(e) => handleChange("time", e.target.value)} />
          ...
          <Stack w="full">
            ...
            {eventData.attachments?.map((att, idx) => (
              <Flex key={idx} align="center" justify="space-between">
                <Button variant="link" color="blue.500" onClick={() => window.open(att.fileUrl, "_blank")}>{att.fileName}</Button>
