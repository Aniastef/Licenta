import {
    ...
    Wrap, WrapItem // Add Wrap and WrapItem for better layout of checkboxes
			...
			try {
				...
				const res = await fetch("/api/products/create", {
					...
					body: JSON.stringify({
						...
						videos: videosBase64,
						audios: audiosBase64,
                        // category is already an array in newProduct state
					}),
				});
					...
					<VStack spacing={4}>
                        ...
                        <FormControl>
                            ...
                            <CheckboxGroup
                                ...
                                onChange={(selectedValues) => // MODIFICATION: Handle array of selected values
                                    setNewProduct({ ...newProduct, category: selectedValues })
                                }
                            >
                                <Wrap spacing={2} mt={2} maxW="100%"> {/* Use Wrap for better layout of checkboxes */}
