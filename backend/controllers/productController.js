...
export const createProduct = async (req, res) => {
	try {
	  ...
	  const newProduct = new Product({
		...
		user: req.user._id, // Asociază utilizatorul autentificat
	  });
...
export const getProduct = async (req, res) => {
	try {
	  ...
	  // Găsește produsul și include detalii despre utilizator
	  const product = await Product.findById(id).populate("user", "firstName lastName email");
	  if (!product) {
